...
export default function Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-secondary p-4">
      ...
      {/* Hidden Export Container - Full content for PDF (Same layout as web) */}
      <div ref={exportRef} className="absolute -left-full -top-full bg-white" style={{ width: '210mm', padding: '24px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', minHeight: 'fit-content' }}>
